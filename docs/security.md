...
- 2 人の member が upload した写真は、それぞれの upload した人を区別して記録する。別の member や storage cleanup が finalize しても、reserve した member が残る。記録の無い写真も読み書きでき、upload した人を補わない（[D-034](decisions.md)）。
